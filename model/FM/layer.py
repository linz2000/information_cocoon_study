...
class FeaturesEmbedding(torch.nn.Module):
    ...
    def get_selected_embedding(self, sel_x, selected_idx_list:list):
        sel_offsets = self.offsets[selected_idx_list]
        sel_x = sel_x + sel_x.new_tensor(sel_offsets).unsqueeze(0)

        return self.embedding(sel_x)
